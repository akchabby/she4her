...
struct TransferFundsPassenger: View {
    @State private var amount: String = ""
    @State private var selectedFromAccount = "Balance"
    @State private var selectedToAccount = "Bank Account"
    @State private var showConfirmAlert = false
    @Environment(\.dismiss) private var dismiss
    
    let fromAccounts = ["Balance", "Credit Card"]
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                HStack(spacing: 0) {
                    Text("$")
                        ...
                        .tfp_cornerRadius(8, corners: [.topLeft, .bottomLeft])
                    ...
                    TextField("0.00", text: $amount)
                        ...
                        .frame(height: 50)
                        .background(Color.white)
                        .tfp_cornerRadius(8, corners: [.topRight, .bottomRight])
                }
                .overlay(
...
// MARK: - Corner Radius Extension (Local)
fileprivate extension View {
    func tfp_cornerRadius(_ radius: CGFloat, corners: UIRectCorner) -> some View {
        clipShape(TFP_RoundedCorner(radius: radius, corners: corners))
    }
}

fileprivate struct TFP_RoundedCorner: Shape {
